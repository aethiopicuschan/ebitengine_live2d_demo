...
void LAppLive2DManager::SetUpModel()
{
    ...
    LAppPal::PrintLog("[HPIC]crawlPath: %s", crawlPath.GetRawString());
...
void LAppLive2DManager::ChangeScene(Csm::csmInt32 index)
{
    ...
    LAppPal::PrintLog("[HPIC]_modelDir size: %d", _modelDir.GetSize());
    ...
    LAppPal::PrintLog("[HPIC]model path: %s", modelPath.GetRawString());
    LAppPal::PrintLog("[HPIC]model json name: %s", modelJsonName.GetRawString());
